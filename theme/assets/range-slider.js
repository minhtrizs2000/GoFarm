(() => {
  ...
  function createRangeSlider() {
    ...
    var input_min_element = document.querySelector(".filter-group__price-range-from input");
    var input_max_element = document.querySelector(".filter-group__price-range-to input");
    var input_max_value = document.querySelector(".filter-group__price-range-to input").getAttribute("max");
    var max_value = parseFloat(input_max_value);
    import_nouislider.default.create(range_slider, {
      start: [0, max_value],
      connect: true,
      step: 1,
      range: {
